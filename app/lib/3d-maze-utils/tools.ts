...
import {idnameprops,nameidprops,hProps,heuristicMapProps,hmapProp,jariPropos,neighborsProps,costProp,insertProp,substractProp} from '@/app/lib/3d-maze-utils/interfaces'
